...
import espaguete from "../data/assets/img/espaguete.jpg";
import lasanha from "../data/assets/img/lasanha.jpg";
import ravioli from "../data/assets/img/ravioli.jpg";
import capeletti from "../data/assets/img/capeletti.jpg";
import nhoque from "../data/assets/img/nhoque.jpg";
import bruschetta from "../data/assets/img/bruschetta.jpg";
import carpaccio from "../data/assets/img/carpaccio.jpg";
import paella from "../data/assets/img/paella.jpg";
import ebiSpicy from "../data/assets/img/ebi-spicy.jpg";
import aligot from "../data/assets/img/aligot.jpg";
import fileMignon from "../data/assets/img/file-mignon.jpg";
import picanha from "../data/assets/img/picanha.png";
import bifeAncho from "../data/assets/img/bife-ancho.jpg";
import tomahwankSteak from "../data/assets/img/tomahawk-steak.jpg";
import primeRib from "../data/assets/img/prime-rib.jpg";
import tiramisu from "../data/assets/img/tiramisu.jpg";
import cheesecake from "../data/assets/img/cheesecake.jpg";
import banoffee from "../data/assets/img/banoffee.png";
import milFolhas from "../data/assets/img/mil-folhas.jpg";
import pudim from "../data/assets/img/pudim.jpg";
import cerveja from "../data/assets/img/cerveja.jpg";
import refrigerante from "../data/assets/img/refrigerante.jpg";
import suco from "../data/assets/img/suco.jpg";
import whiskey from "../data/assets/img/whiskey.jpg";
import agua from "../data/assets/img/agua.jpg";
import saladaCeasar from "../data/assets/img/salada-ceasar.jpg";
import saladaCaprese from "../data/assets/img/salada-caprese.jpg";
import saladaWaldorf from "../data/assets/img/salada-waldorf.jpg";
import saladaGrega from "../data/assets/img/salada-grega.jpg";
import saladaNicoise from "../data/assets/img/salada-nicoise.jpg";
